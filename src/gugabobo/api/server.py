...
def dashboard_control_config(_: None = Depends(require_admin_token)) -> dict[str, object]:
    ...
    return {
        "values": {
            ...
            "GUGABOBO_TELEGRAM_FILE_MAX_BYTES": settings.telegram_file_max_bytes,
            "GUGABOBO_TELEGRAM_FILE_TIMEOUT_SECONDS": settings.telegram_file_timeout_seconds,
            ...
            "GUGABOBO_GITHUB_ISSUE_CREATE_REPOSITORIES": settings.github_issue_create_repositories,
